...
public class RegisterController extends HttpServlet {
    ...
    private final String USER_ROLE = "member";
    private final String NEW_STATUS = "New";
    private final String SUCCESS = "registerPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            AccountDTO newAccount = new AccountDTO(email, passwordSha256, name, USER_ROLE, NEW_STATUS);
            AccountDAO dao = new AccountDAO();
            boolean result = dao.createAccount(newAccount);
            if (result) {
                url = SUCCESS;
                request.setAttribute("MSGSUCCESS", "Create account successfull");
            }
