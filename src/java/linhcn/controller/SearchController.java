...
public class SearchController extends HttpServlet {
    ...
    private final static String SUCCESS = "managePage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int pages = dao.getTotalPageSearchAndStatus(search, slStatus);
            List<ArticleDTO> list = dao.getAllActicle(search, slStatus, page);

            request.setAttribute("SEARCH", search);
            request.setAttribute("STATUS", slStatus);
